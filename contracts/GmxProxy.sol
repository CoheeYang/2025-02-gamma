 ...
 *  this contract is not a library and is not recommended for several perpetual vaults to share a GMXProxy contract
 *  We should create one GMXProxy instance for one perpertual vault because all GMX positions are
 *  registered as GMXProxy address in GMX protocol
 */

contract GmxProxy is
  IGmxProxy,
